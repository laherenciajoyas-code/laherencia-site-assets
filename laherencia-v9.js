(function() {
  ...
  // ============================================================
  // LA HERENCIA JOYAS — Site Enhancement Script v9
  ...
  onReady(function() {
    ...
    css.textContent = [
      ...
      // — Slider/Hero — TANE-inspired: editorial, dramatic + text legibility —
      '.theme-slider .theme-section__subtitle { font-family: "Raleway", sans-serif !important; font-weight: 300 !important; letter-spacing: 0.2em !important; font-size: 0.75rem !important; text-transform: uppercase; text-shadow: 0 1px 8px rgba(0,0,0,0.5), 0 0 15px rgba(0,0,0,0.25) !important; }',
      '.theme-slider .theme-section__title { font-family: "Cormorant Garamond", Georgia, serif !important; font-weight: 300 !important; letter-spacing: 0.08em !important; font-size: 3rem !important; text-shadow: 0 2px 12px rgba(0,0,0,0.5), 0 0 25px rgba(0,0,0,0.25) !important; }',
      '.theme-slider .theme-section__description { text-shadow: 0 1px 6px rgba(0,0,0,0.4) !important; }',
      ...
      // — Logo — forzar color negro sobre header oscuro —
      '.header__logo img, .header__logo svg, .header-logo img, .logo img, a.header__logo img { filter: brightness(0) !important; }',
